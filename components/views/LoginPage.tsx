            ...
            <div className="max-w-md w-full mx-auto z-10">
                ...
                <div className="bg-white/60 backdrop-blur-xl p-8 rounded-2xl shadow-lg border border-white/20">
                    <div className="text-center mb-6">
                        <h2 className="text-2xl font-bold text-neutral-700">Welcome Back!</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button type="submit" className="w-full bg-primary hover:bg-primary-dark text-white font-bold py-3 rounded-lg transition-all shadow-md hover:shadow-lg hover:scale-105 active:scale-100 transform">
                            Login
                        </button>
                    </form>
